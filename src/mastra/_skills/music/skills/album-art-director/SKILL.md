...
description: "This skill should be used when art-directing album covers, single artwork, visual identity, or image-generation prompts derived from music concepts, lyrics, genre, and release context."
license: CC0-1.0
user-invocable: true
tags: [album-art, visual-direction, cover, prompt]
metadata:
  version: "1.0.0"
  updated: "2026-06-23"
  parent: "musician"
  source_repo: "bitwize-music-studio/claude-ai-music-skills"
  source_skill: "album-art-director"
...
This is a Mastra musician-domain port of the CC0 `album-art-director` skill from `bitwize-music-studio/claude-ai-music-skills`. Use the craft guidance below, but obey the local runtime contract first.
...
- Load `album-types.md` with `music_load_reference` using `kind:"skill"`, `name:"album-art-director/album-types"`.
- Load `prompt-examples.md` with `music_load_reference` using `kind:"skill"`, `name:"album-art-director/prompt-examples"`.
- Load `visual-styles.md` with `music_load_reference` using `kind:"skill"`, `name:"album-art-director/visual-styles"`.
...
1. Consult user/project preferences for `album-art-preferences.md` if available in memory, project notes, or future override storage.
...
1. **Load override first** - Consult user/project preferences for `album-art-preferences.md` if available in memory, project notes, or future override storage.
