---
name: voice-checker
description: "This skill should be used when checking lyrics, album copy, or promotional text for generic AI voice, cliche escalation, abstract noun stacking, missing specificity, or authenticity problems."
license: CC0-1.0
user-invocable: true
tags: [voice, authenticity, lyrics, copy]
metadata:
  version: "1.0.0"
  updated: "2026-06-23"
  parent: "musician"
  source_repo: "bitwize-music-studio/claude-ai-music-skills"
  source_skill: "voice-checker"
...
This is a Mastra musician-domain port of the CC0 `voice-checker` skill from `bitwize-music-studio/claude-ai-music-skills`. Use the craft guidance below, but obey the local runtime contract first.
...
1. Read the file
2. Search for a `lyrics` field (fenced code block or section labeled "Lyrics", "active music surface Lyrics", or "distribution lyrics")
3. **`lyrics` field found** → lyrics mode (Classes 1–7)
4. **No `lyrics` field** → prose mode (Classes 8–11)
...
### After This Skill
- `pre-generation-check` — validates all gates before music generation (lyrics path)
