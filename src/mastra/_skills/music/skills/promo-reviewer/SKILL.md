---
name: promo-reviewer
description: "This skill should be used when reviewing promotional music copy for platform fit, length, hook strength, compliance, tone, hashtags, and release campaign readiness."
license: CC0-1.0
user-invocable: true
tags: [promotion, review, social, quality-gate]
metadata:
  version: "1.0.0"
  updated: "2026-06-23"
  parent: "musician"
  source_repo: "bitwize-music-studio/claude-ai-music-skills"
  source_skill: "promo-reviewer"
...
This is a Mastra musician-domain port of the CC0 `promo-reviewer` skill from `bitwize-music-studio/claude-ai-music-skills`. Use the craft guidance below, but obey the local runtime contract first.
...
- Load `platform-rules.md` with `music_load_reference` using `kind:"skill"`, `name:"promo-reviewer/platform-rules"`.
...
- After `[skill:promo-writer]` generates initial copy
...
Options:
1. Generate promo copy: [skill:promo-writer] <album-name>
...
Next steps:
  ...
  3. Ready for release: [skill:release-director] <album>
```
