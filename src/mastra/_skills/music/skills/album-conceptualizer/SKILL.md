...
description: "This skill should be used when planning an album, EP, multi-track project, tracklist, narrative arc, thematic system, sonic palette, or sequencing strategy for musicianAgent."
license: CC0-1.0
user-invocable: true
tags: [album, concept, tracklist, planning]
metadata:
  version: "1.0.0"
  updated: "2026-06-23"
  parent: "musician"
  source_repo: "bitwize-music-studio/claude-ai-music-skills"
  source_skill: "album-conceptualizer"
...
This is a Mastra musician-domain port of the CC0 `album-conceptualizer` skill from `bitwize-music-studio/claude-ai-music-skills`. Use the craft guidance below, but obey the local runtime contract first.
...
- Load `album-types.md` with `music_load_reference` using `kind:"skill"`, `name:"album-conceptualizer/album-types"`.
...
### Loading Override
1. Consult user/project preferences for `album-planning-guide.md` if available in memory, project notes, or future override storage.
...
See also: `[ref:workflows/album-planning-phases]` once workflow references are ported.
...
Discuss visual concept early — actual generation happens later via `[skill:album-art-director]`.
...
4. `tracks/XX-track-name.md` - Individual track files
   ...
   - Instrumental tracks skip lyrics-related workflow sections (distribution lyrics, Pronunciation Notes, Phonetic Review Checklist)
   - Workflow routing: instrumental tracks go directly to `[skill:style-prompt-engineer]` (no lyric-writer/reviewer/pronunciation)
...
1. **Load override first** - Consult user/project preferences for `album-planning-guide.md` if available in memory, project notes, or future override storage.
