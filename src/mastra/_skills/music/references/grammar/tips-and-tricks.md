> Ported from `bitwize-music-studio/claude-ai-music-skills/reference/suno/tips-and-tricks.md` (CC0-1.0) on 2026-06-23. Suno-native reference. Use only when the active surface is `suno-gateway`; otherwise translate through `[ref:grammar/surface-grammar-adapter]`.
