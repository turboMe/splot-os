> Ported from `bitwize-music-studio/claude-ai-music-skills/reference/streaming-mastering-specs.md` (CC0-1.0) on 2026-06-23. Music reference corpus document. Use as loader-only knowledge for musicianAgent; do not treat it as local runtime infrastructure.
