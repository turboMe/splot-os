...
keywords: [github, ci, actions, pr, checks, failing, debug, fix, pipeline, workflow]
...
- `python "gh-fix-ci-scripts/inspect_pr_checks.py" --repo "." --pr "<number-or-url>"`
...
Usage examples:
- `python "gh-fix-ci-scripts/inspect_pr_checks.py" --repo "." --pr "123"`
- `python "gh-fix-ci-scripts/inspect_pr_checks.py" --repo "." --pr "https://github.com/org/repo/pull/123" --json`
- `python "gh-fix-ci-scripts/inspect_pr_checks.py" --repo "." --max-lines 200 --context 40`
