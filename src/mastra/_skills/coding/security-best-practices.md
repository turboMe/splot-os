...
keywords: [security, review, audit, vulnerability, xss, csrf, injection, best-practices, typescript, react, nextjs, python, express]
...
- If matching guidance exists in `security-best-practices-references/`, load only the relevant files and follow their instructions.
...
The `security-best-practices-references/` directory contains security guidelines for:

- `golang-general-backend-security.md` — Go backend
- `javascript-express-web-server-security.md` — Express.js
- `javascript-general-web-frontend-security.md` — General frontend JS
- `javascript-jquery-web-frontend-security.md` — jQuery frontend
- `javascript-typescript-nextjs-web-server-security.md` — Next.js server
- `javascript-typescript-react-web-frontend-security.md` — React frontend
- `javascript-typescript-vue-web-frontend-security.md` — Vue.js frontend
