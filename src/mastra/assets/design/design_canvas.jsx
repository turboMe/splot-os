/**
 * DesignCanvas — Variant Side-by-Side Grid Layout
 *
 * Used to display 2+ static design variations for users to compare and choose from.
 * Each variation has a label and can be clicked to expand.
 *
 * Usage:
 *   <DesignCanvas
 ...
 *     columns={3}
 *   >
 *     <Variation label="Minimal" description="Minimalist and Restrained Version">
 *       <div>...Your design 1...</div>
 *     </Variation>
 *     <Variation label="Editorial" description="Magazine Editorial Style">
 *       <div>...Your design 2...</div>
 *     </Variation>
 *     <Variation label="Brutalist" description="Rough and Raw">
 *       <div>...Your design 3...</div>
 *     </Variation>
 *   </DesignCanvas>
 *
 * Intended for use with React + Babel. Place it in an appropriate script, then `window.DesignCanvas` and `window.Variation` will be available.
 */
