 ...
 * - Stage: The entire animation container, provides time + controls
 * - Sprite: A time segment, visible within start/end, provides local progress
 * - useTime(): Reads global time (seconds)
 * - useSprite(): Reads local progress {t: 0→1, elapsed: seconds, duration: seconds}
 ...
 *   </Stage>
 *
 * Use useSprite() in Sprite's child components to read the current segment's progress.
 */
...
(function() {
  ...
  const Easing = {
    ...
    // Fast start + slow stop, gives numerical elements a sense of physical weight
    expoOut: t => t === 1 ? 1 : 1 - Math.pow(2, -10 * t),
    // overshoot: Elastic toggle/button pop-out (cubic-bezier(0.34, 1.56, 0.64, 1))
    overshoot: t => {
