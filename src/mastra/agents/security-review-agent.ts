...
export const securityReviewAgent: Agent = new Agent({
  id: 'security-review-agent',
  name: 'Security Review Agent',
  instructions: `${await loadPrompt('coding/security-review')}\n\n${await loadPrompt('shared/skill-shelf')}`,
  ...
  inputProcessors: [createUnifiedCapabilityShelfProcessor({ agentId: 'security-review-agent' })],
